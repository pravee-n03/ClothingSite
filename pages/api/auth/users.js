...
import signupController from "../../../controller/authController/userSignupController";
...
const reqHandler = async (req, res) => {
  try {
    if (req.method === "POST") {
      ...
      await clientAccessController(req, res, false);
    } else if (req.method === "PUT") {
      await loginController(req, res, false);
